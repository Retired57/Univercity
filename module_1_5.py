...
immutable_tuple = (5, 4.56, "Hello", True, [1,2,3])
print("Неизменяемый кортеж: ",immutable_tuple)

print("Третий элемент кортежа: ", immutable_tuple[2])
# immutable_tuple[2] = "Привет" - здесь выдал ошибку - кортеж не поддерживает такое присвоение значений
